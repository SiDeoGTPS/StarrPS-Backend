                                                        ...
                                                        <div class="container">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <form
                                                                        method="POST"
                                                                        action="https://gtlogin-backend.vercel.app/player/growid/login/validate"
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <a
                                                                                href="https://wa.me/6288269970304"
                                                                                target="_blank"
                                                                                >Problem? Chat Febry</a
                                                                            >
                                                                        </div>
                                                                        <div
        ...
        $('document').ready(function () {
            ...
            $('.close').on('click', function () {
                window.location = // change the host into your own backend host
                    'https://starr-ps-backend.vercel.app/player/validate/close'; // https instead of http if u r using ssl
            });
